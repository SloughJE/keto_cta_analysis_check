...
- **Model dependence & collinearity:** ApoB, LDL‐C, non‐HDL correlate → partial $R^2$ unstable.
- **Small samples:** partial $R^2$ can be very noisy
- **Mixed model families:** GLM/mixed/hurdle lack a single standard $R^2$ 
:::
::: {.incremental}

- **Plaque progression convention:** report $\beta$/OR with 95% CI and p-values.
- **Clinical interpretability:** "Δ outcome per 10 mg/dL ApoB" > "% residual variance."
:::
...
4. Despite "corroborated" claim, model assumptions were violated. Many misspecified models 
